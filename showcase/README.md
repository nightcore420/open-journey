...
| ---- | ------- | ----------- | ----------------- |
| 2025 | [Open Journey - AI-Powered Learning Platform](2025/example-open-journey.md) | [Alex Developer](https://github.com/alexdev) | An AI-powered learning platform that creates personalized educational paths using machine learning to adapt to each learner's pace and style. |
| 2025 | [Example Project Entry](2025/example-project.md) | [Open Journey Team](https://github.com/nightcore420) | Minimal example entry used by CI to demonstrate the showcase format. |

<!-- SHOWCASE_TABLE_END -->

_Your project could be next!_
...
_Proyekmu bisa menjadi yang berikutnya!_
