...
#### _Ja tu nejūties ērti ar komandrindu, [izmanto GUI rīku pamācības.](#pamācības-citiem-rīkiem)_
...
Izveido savu repozitorija atzarojumu, nospiežot _fork_ pogu šīs lapas augšpusē.
...
Tagad klonē nokopēto repozitoriju savā datorā. Ej uz savu GitHub profilu, atver nokopēto repozitoriju, nospied _clone_ pogu un tad nospied uz _copy to clipboard_ ikonas.
...
kur `tavs-vārds` ir tavs GitHub lietotājvārds. Šādi tu kopē GitHub repozitorija _first-contributions_ saturu savā datorā.
...
(Zara nosaukumā nav obligāti jābūt vārdam _add_, bet būtu lietderīgi to iekļaut, jo šī zara mērķis ir tava vārda pievienošana sarakstam.)
