...
#### _Om du inte känner dig bekväm med kommandoraden, [så finns en vägledning här.](#Handledningar-för-andra-verktyg)_
...
Klona repot till din dator. Gå till ditt GitHub-konto och klicka på clone-knappen och klicka sedan på _copy to clipboard_-ikonen.
