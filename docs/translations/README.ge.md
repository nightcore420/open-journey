...
ეს პროექტი ეხმარება დამწყებ "დეველოპერებს" რათა გაუადვილდეთ პირველი კონტრიბუცია Github*ზე. თუ გინდა რომ პირველი შენი დაწერილი კოდი Github*ზე ათვირთო მაშინ მიყევი ქვემოთ მოცემულ ინსტრუქციას.
...
#### _თუ ტერმინალთან დიდად არ მეგობრობ, [აქ ნახავ რამდენიმე პროგრამას, რომელიც ტერმინალის გამოყენებას აგარიდებს თავიდან](#ტუტორიალები-სხვა-პროგრამების-გამოყენებით)_
...
ახლა, დაფორკილი რეპოზიტორია შენს კომპიუტერზე უნდა გადმოიტანო. ამისთვის შედი შენს გითჰაბის პროფილზე, გახსენი რეპოზიტორია და დააჭირე "Clone or download"-ს, შემდეგ კი _"copy to clipboard"_-ის სურათს.
...
(ბრენჩის სახელის დასაწყისში _add_-ის მიწერა სავალდებულო არაა, თუმცა მიზანშეწონილია, რადგანაც მისი მთავარი მიზანია თქვენი სახელი დაამატოს კონტრიბუტორთა სიაში.)
