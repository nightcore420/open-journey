...
Mahirap. Palaging mahirap sa unang pagkakataon ng anumang gawain. Lalo na sa isang kolaborasyon, kung saan hindi komportableng paglaanan ng tuon ang mga pagkakamali. Gusto naming simplehan at linawin ang modernong pamamaraan kung papaanong matuto at tumulong ang mga bagong _open-source contributors_.

Maaaring makatulong ang pagbabasa ng mga artikulo at panonood ng mga _tutorials_, pero ano pa bang mas epektibong pamamaraan kaysa sa aktual na aplikasyon ng isang pagsasanay? Ang pangunahing pakay ng proyektong ito ay gabayan ang mga baguhan na gawin ang kanilang unang _contribution_. Kung ikaw ay isa sa mga taong iyon, sundin lang ang mga sumusunod na tagubilin.

Kung hindi comfortable sa paggamit ng _command line_, [may mga tutorials din gamit ang mga _GUI_ tools.](#Mga-tutorials-gamit-ang-ibang-tools)\*

<img align="right" width="300" src="https://firstcontributions.github.io/assets/Readme/fork.png" alt="fork this repository" />

Kung wala pang _git_ sa iyong computer, [i-install ito](https://help.github.com/articles/set-up-git/).

## I-fork ang repository

I-fork ang _repository_ sa pamamagitan ng pag-click sa _fork_ _button_ na matatagpuan sa bandang itaas na kanan ng _webpage_ na ito.
Magkakaroon na ng kopya ng _repository_ na ito sa iyong account.
...
Pumunta lang sa iyong GitHub account, buksan ang nai-fork na repository, i-click ang clone button pagkatapos i-click ang _copy to clipboard_ icon.
...
(Hindi kailangan ng salitang _"dagdag"_ sa pangalan ng i-dadagdag na branch pero makatwiran pa rin na gawin dahil layunin ng branch ang pagdagdag ng iyong pangalan sa isang listahan.)
