...
Click the _Checkbox_ to **add** the file to the staging area. Then enter a commit message.

_Note: You can also select files (both in the staging and unstaged areas) and add/remove files from the respective areas by using the spacebar_
