...
**Proyek ini berpartisipasi dalam Hacktoberfest 2025!** Kami menyambut kontributor Indonesia untuk membuat kontribusi pertama mereka dan mendapatkan pengalaman open source yang nyata.

### 🌟 Cara Berpartisipasi dalam Hacktoberfest

1. **Daftar di Hacktoberfest**: Kunjungi [hacktoberfest.com](https://hacktoberfest.com) dan daftarkan akun GitHub Anda
2. **Pilih Issue**: Cari issue dengan label `good first issue` atau `hacktoberfest`
3. **Buat Pull Request**: Ikuti panduan di bawah untuk membuat PR pertama Anda
4. **Dapatkan Swag**: Setelah 4 PR yang valid, Anda bisa mendapatkan hadiah digital atau menanam pohon!

### 🎯 Issue yang Cocok untuk Pemula

Kami memiliki berbagai issue yang ramah pemula:

- ✅ Menambahkan nama ke daftar Contributors
- 📝 Memperbaiki typo atau kesalahan ketik
- 🌐 Menerjemahkan konten ke Bahasa Indonesia
- 📚 Menambahkan resource pembelajaran baru
- 📖 Membuat glosarium istilah Git dalam Bahasa Indonesia

**Lihat semua issue**: [Good First Issues](https://github.com/firstcontributions/first-contributions/labels/good%20first%20issue)

### 📚 Panduan Lengkap Bahasa Indonesia

Baca panduan lengkap dalam Bahasa Indonesia: [README Bahasa Indonesia](docs/translations/README.id.md)

### 🤝 Butuh Bantuan?

- Baca [CONTRIBUTING.md](CONTRIBUTING.md) untuk panduan kontribusi
- Ikuti [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md) kami
- Tanya di issue atau diskusi jika ada yang kurang jelas

**Selamat berkontribusi dan selamat Hacktoberfest 2025! 🚀**
...
Have you built something amazing? Share it with the community! Visit our [**Project Showcase**](showcase/README.md) to:

- 📢 Share your personal projects
- 🎨 Get feedback from other developers
- 💼 Build your portfolio
- 🏆 Earn Hacktoberfest credit

Whether it's a web app, mobile app, bot, or any creative project – we'd love to see it!
